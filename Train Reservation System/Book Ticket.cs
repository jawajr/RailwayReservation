    ...
    public partial class Book_Ticket : Form
    {
        ...
        void save()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("insert into Ticket(ticketNo,trainNo,userID,ticketPrice,seatType) " +
                    "values(@ticketNo,@trainNo,@ticketPrice,@seatType)", sql);
                ...
                cmd.Parameters.AddWithValue("@ticketPrice", 200);
                //cmd.Parameters.AddWithValue("", coachNoBox.Text);
                cmd.ExecuteNonQuery();
